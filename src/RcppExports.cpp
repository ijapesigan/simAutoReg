...
RcppExport SEXP _simAutoReg_PBootVARLasso(SEXP dataSEXP, SEXP pSEXP, SEXP BSEXP, SEXP burn_inSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type data(dataSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type B(BSEXP);
    Rcpp::traits::input_parameter< int >::type burn_in(burn_inSEXP);
    rcpp_result_gen = Rcpp::wrap(PBootVARLasso(data, p, B, burn_in));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_simAutoReg_PBootVARLasso", (DL_FUNC) &_simAutoReg_PBootVARLasso, 4},
    {NULL, NULL, 0}
};
