...
// SimVAR2
arma::mat SimVAR2(int time, int burn_in, const arma::vec& constant, const arma::mat& coef, const arma::mat& chol_cov);
RcppExport SEXP _simAutoReg_SimVAR2(SEXP timeSEXP, SEXP burn_inSEXP, SEXP constantSEXP, SEXP coefSEXP, SEXP chol_covSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type time(timeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(SimVAR2(time, burn_in, constant, coef, chol_cov));
    return rcpp_result_gen;
END_RCPP
}
// SimVARCoef
...
// SimVARExo2
arma::mat SimVARExo2(int time, int burn_in, const arma::vec& constant, const arma::mat& coef, const arma::mat& chol_cov, const arma::mat& exo_mat, const arma::mat& exo_coef);
RcppExport SEXP _simAutoReg_SimVARExo2(SEXP timeSEXP, SEXP burn_inSEXP, SEXP constantSEXP, SEXP coefSEXP, SEXP chol_covSEXP, SEXP exo_matSEXP, SEXP exo_coefSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type time(timeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(SimVARExo2(time, burn_in, constant, coef, chol_cov, exo_mat, exo_coef));
    return rcpp_result_gen;
END_RCPP
}
// SimVARExo
...
// SimVARZIP2
arma::mat SimVARZIP2(int time, int burn_in, const arma::vec& constant, const arma::mat& coef, const arma::mat& chol_cov);
RcppExport SEXP _simAutoReg_SimVARZIP2(SEXP timeSEXP, SEXP burn_inSEXP, SEXP constantSEXP, SEXP coefSEXP, SEXP chol_covSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type time(timeSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::mat& >::type coef(coefSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type chol_cov(chol_covSEXP);
    rcpp_result_gen = Rcpp::wrap(SimVARZIP2(time, burn_in, constant, coef, chol_cov));
    return rcpp_result_gen;
END_RCPP
}
// SimVARZIPExo2
arma::mat SimVARZIPExo2(int time, int burn_in, const arma::vec& constant, const arma::mat& coef, const arma::mat& chol_cov, const arma::mat& exo_mat, const arma::mat& exo_coef);
RcppExport SEXP _simAutoReg_SimVARZIPExo2(SEXP timeSEXP, SEXP burn_inSEXP, SEXP constantSEXP, SEXP coefSEXP, SEXP chol_covSEXP, SEXP exo_matSEXP, SEXP exo_coefSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type time(timeSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::mat& >::type exo_mat(exo_matSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type exo_coef(exo_coefSEXP);
    rcpp_result_gen = Rcpp::wrap(SimVARZIPExo2(time, burn_in, constant, coef, chol_cov, exo_mat, exo_coef));
    return rcpp_result_gen;
END_RCPP
}
// SimVARZIPExo
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_simAutoReg_SimVAR2", (DL_FUNC) &_simAutoReg_SimVAR2, 5},
    {"_simAutoReg_SimVARCoef", (DL_FUNC) &_simAutoReg_SimVARCoef, 2},
    {"_simAutoReg_SimVARExo2", (DL_FUNC) &_simAutoReg_SimVARExo2, 7},
    {"_simAutoReg_SimVARExo", (DL_FUNC) &_simAutoReg_SimVARExo, 7},
    {"_simAutoReg_SimVARZIP2", (DL_FUNC) &_simAutoReg_SimVARZIP2, 5},
    {"_simAutoReg_SimVARZIPExo2", (DL_FUNC) &_simAutoReg_SimVARZIPExo2, 7},
