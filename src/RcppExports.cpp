...
RcppExport SEXP _simAutoReg_SimMVNFixed(SEXP nSEXP, SEXP locationSEXP, SEXP scaleSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
    Rcpp::traits::input_parameter< const arma::vec& >::type location(locationSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type scale(scaleSEXP);
    rcpp_result_gen = Rcpp::wrap(SimMVNFixed(n, location, scale));
    return rcpp_result_gen;
END_RCPP
}
// SimMVN
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_simAutoReg_SimMVNFixed", (DL_FUNC) &_simAutoReg_SimMVNFixed, 3},
