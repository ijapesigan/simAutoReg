...
#' @keywords simAutoReg fit
#' @export
FitVARLassoSearch <- function(Y_std, X_std, lambdas, crit = "ebic", max_iter = 10000L, tol = 1e-5) {
    .Call(`_simAutoReg_FitVARLassoSearch`, Y_std, X_std, lambdas, crit, max_iter, tol)
}
