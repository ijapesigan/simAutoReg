...
#' @keywords simAutoReg sim
#' @export
SimVAR2 <- function(time, burn_in, constant, coef, chol_cov) {
    .Call(`_simAutoReg_SimVAR2`, time, burn_in, constant, coef, chol_cov)
}
...
#' @keywords simAutoReg sim
#' @export
SimVARExo2 <- function(time, burn_in, constant, coef, chol_cov, exo_mat, exo_coef) {
    .Call(`_simAutoReg_SimVARExo2`, time, burn_in, constant, coef, chol_cov, exo_mat, exo_coef)
}
...
#' @keywords simAutoReg sim
#' @export
SimVARZIP2 <- function(time, burn_in, constant, coef, chol_cov) {
    .Call(`_simAutoReg_SimVARZIP2`, time, burn_in, constant, coef, chol_cov)
}
...
#' @keywords simAutoReg sim
#' @export
SimVARZIPExo2 <- function(time, burn_in, constant, coef, chol_cov, exo_mat, exo_coef) {
    .Call(`_simAutoReg_SimVARZIPExo2`, time, burn_in, constant, coef, chol_cov, exo_mat, exo_coef)
}
