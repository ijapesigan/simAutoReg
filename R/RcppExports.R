...
#' @export
FitVARLasso <- function(Y_std, X_std, lambda, max_iter = 10000L, tol = 1e-5) {
    .Call(`_simAutoReg_FitVARLasso`, Y_std, X_std, lambda, max_iter, tol)
}
...
#' @keywords simAutoReg fit
#' @export
SearchVARLasso <- function(Y_std, X_std, lambdas, max_iter = 10000L, tol = 1e-5) {
    .Call(`_simAutoReg_SearchVARLasso`, Y_std, X_std, lambdas, max_iter, tol)
}
...
#' @export
OrigScale <- function(coef_std, sd_Y, sd_X, mean_Y, mean_X) {
    .Call(`_simAutoReg_OrigScale`, coef_std, sd_Y, sd_X, mean_Y, mean_X)
}
