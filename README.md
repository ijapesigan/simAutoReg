...
Research compendium for the manuscript Monte Carlo Confidence Intervals
for Indirect Effects in Ecological Momentary Assessment: A Dynamical
Systems Approach.
...
See [Quarto Pub](https://ijapesigan.quarto.pub/simAutoReg) for package
